...
import io.github.solaceharmony.codex.utils.concurrent.Notify
...
class UnifiedExecSessionManager {
    ...
    suspend fun openSessionWithExecEnv(env: ExecEnv): UnifiedExecSession {
        ...
        val spawned =
                io.github.solaceharmony.codex.utils.pty.spawnPtyProcess(program, args, env.cwd, env.env, scope)
    ...
    suspend fun openSessionWithSandbox(
        ...
        val spec =
                CommandSpec(
                        ...
                        expiration =
                                io.github.solaceharmony.codex.core.ExecExpiration
        ...
        val policy = io.github.solaceharmony.codex.protocol.SandboxPolicy.DangerFullAccess
        val sandboxType = io.github.solaceharmony.codex.core.platformGetSandbox() ?: SandboxType.None
