...
import io.github.solaceharmony.codex.client.auth.AuthManager
import io.github.solaceharmony.codex.client.auth.AuthMode
import io.github.solaceharmony.codex.core.context.ContextManager
import io.github.solaceharmony.codex.core.context.TruncationPolicy
import io.github.solaceharmony.codex.core.context.truncateText
import io.github.solaceharmony.codex.core.CodexErr
import io.github.solaceharmony.codex.core.CodexResult
import io.github.solaceharmony.codex.core.features.Feature
import io.github.solaceharmony.codex.core.features.Features
import io.github.solaceharmony.codex.core.ProcessedResponseItem
import io.github.solaceharmony.codex.core.ToolCallProcessor
...
import io.github.solaceharmony.codex.core.tools.ToolCall
import io.github.solaceharmony.codex.core.tools.ToolCallRuntime
import io.github.solaceharmony.codex.core.tools.ToolRegistry
import io.github.solaceharmony.codex.core.tools.ToolRouter
import io.github.solaceharmony.codex.core.tools.newToolsConfig
import io.github.solaceharmony.codex.core.model.ApplyPatchToolType
...
import io.github.solaceharmony.codex.core.model.deriveDefaultModelFamily
import io.github.solaceharmony.codex.exec.sandbox.ApprovalStore
import io.github.solaceharmony.codex.protocol.SandboxCommandAssessment
import io.github.solaceharmony.codex.protocol.SandboxRiskLevel
import io.github.solaceharmony.codex.exec.shell.Shell
import io.github.solaceharmony.codex.exec.shell.ShellDetector
import io.github.solaceharmony.codex.mcp.connection.McpConnectionManager
import io.github.solaceharmony.codex.mcp.connection.McpServerConfig
import io.github.solaceharmony.codex.protocol.ResponseEvent
import io.github.solaceharmony.codex.utils.concurrent.CancellationToken
import io.github.solaceharmony.codex.protocol.AskForApproval
import io.github.solaceharmony.codex.protocol.ApplyPatchApprovalRequestEvent
import io.github.solaceharmony.codex.protocol.BackgroundEventEvent
import io.github.solaceharmony.codex.protocol.Event
import io.github.solaceharmony.codex.protocol.EventMsg
import io.github.solaceharmony.codex.protocol.ExecApprovalRequestEvent
import io.github.solaceharmony.codex.protocol.ItemCompletedEvent
import io.github.solaceharmony.codex.protocol.ItemStartedEvent
import io.github.solaceharmony.codex.protocol.Op
import io.github.solaceharmony.codex.protocol.RawResponseItemEvent
import io.github.solaceharmony.codex.protocol.ReviewDecision
import io.github.solaceharmony.codex.protocol.SandboxPolicy
import io.github.solaceharmony.codex.protocol.StreamErrorEvent
import io.github.solaceharmony.codex.protocol.Submission
import io.github.solaceharmony.codex.protocol.TaskCompleteEvent
import io.github.solaceharmony.codex.protocol.TaskStartedEvent
import io.github.solaceharmony.codex.protocol.TokenCountEvent
import io.github.solaceharmony.codex.protocol.TurnAbortReason
import io.github.solaceharmony.codex.protocol.TurnAbortedEvent
import io.github.solaceharmony.codex.protocol.TurnItem
import io.github.solaceharmony.codex.protocol.UndoCompletedEvent
import io.github.solaceharmony.codex.protocol.UndoStartedEvent
import io.github.solaceharmony.codex.protocol.CodexErrorInfo
import io.github.solaceharmony.codex.protocol.ErrorEvent
import io.github.solaceharmony.codex.protocol.GetHistoryEntryResponseEvent
import io.github.solaceharmony.codex.protocol.McpListToolsResponseEvent
import io.github.solaceharmony.codex.protocol.ListCustomPromptsResponseEvent
import io.github.solaceharmony.codex.protocol.SessionConfiguredEvent
import io.github.solaceharmony.codex.protocol.McpTool
import io.github.solaceharmony.codex.protocol.McpResource
import io.github.solaceharmony.codex.protocol.McpResourceTemplate
import io.github.solaceharmony.codex.protocol.McpAuthStatus
import io.github.solaceharmony.codex.protocol.CustomPrompt
import io.github.solaceharmony.codex.protocol.ReviewRequest
import io.github.solaceharmony.codex.protocol.ElicitationAction
import io.github.solaceharmony.codex.protocol.TokenUsage
import io.github.solaceharmony.codex.protocol.TokenUsageInfo
import io.github.solaceharmony.codex.protocol.RateLimitSnapshot
import io.github.solaceharmony.codex.protocol.HistoryEntry
...
import io.github.solaceharmony.codex.protocol.TurnContextItem
import io.github.solaceharmony.codex.protocol.TurnDiffEvent
import io.github.solaceharmony.codex.protocol.AgentMessageContentDeltaEvent
import io.github.solaceharmony.codex.protocol.ReasoningContentDeltaEvent
import io.github.solaceharmony.codex.protocol.ReasoningRawContentDeltaEvent
import io.github.solaceharmony.codex.protocol.AgentReasoningSectionBreakEvent
import io.github.solaceharmony.codex.protocol.RolloutItem
import io.github.solaceharmony.codex.protocol.UserMessageItem
import io.github.solaceharmony.codex.protocol.ReasoningItem
import io.github.solaceharmony.codex.protocol.ReasoningItemReasoningSummary
import io.github.solaceharmony.codex.protocol.ReasoningItemContent
import io.github.solaceharmony.codex.protocol.WebSearchItem
import io.github.solaceharmony.codex.protocol.FunctionCallOutputPayload
import io.github.solaceharmony.codex.protocol.InitialHistory
import io.github.solaceharmony.codex.protocol.SessionSource
import io.github.solaceharmony.codex.protocol.UserInput as ProtocolUserInput
import io.github.solaceharmony.codex.protocol.ContentItem
import io.github.solaceharmony.codex.protocol.ResponseInputItem
import io.github.solaceharmony.codex.protocol.ResponseItem
import io.github.solaceharmony.codex.protocol.WarningEvent
import io.github.solaceharmony.codex.protocol.ContextCompactedEvent
import io.github.solaceharmony.codex.protocol.ExitedReviewModeEvent
import io.github.solaceharmony.codex.protocol.ReviewOutputEvent
import io.github.solaceharmony.codex.protocol.ReviewFinding
import io.github.solaceharmony.codex.protocol.ReviewCodeLocation
import io.github.solaceharmony.codex.protocol.ReviewLineRange
import io.github.solaceharmony.codex.protocol.ExecCommandBeginEvent
import io.github.solaceharmony.codex.protocol.ExecCommandEndEvent
import io.github.solaceharmony.codex.protocol.ExecCommandSource
import io.github.solaceharmony.codex.protocol.ParsedCommand
...
import io.github.solaceharmony.codex.utils.git.CreateGhostCommitOptions
import kotlin.time.Duration
import kotlin.time.measureTime
import io.github.solaceharmony.codex.utils.git.GhostSnapshotReport
import io.github.solaceharmony.codex.utils.git.GitToolingError
import io.github.solaceharmony.codex.utils.git.ShellGitOperations
import io.github.solaceharmony.codex.utils.readiness.ReadinessFlag
import io.github.solaceharmony.codex.utils.readiness.ReadinessToken
...
class Session private constructor(
    ...
    suspend fun requestPatchApproval(
        turnContext: TurnContext,
        callId: String,
        changes: Map<String, io.github.solaceharmony.codex.protocol.FileChange>,
        reason: String?,
        grantRoot: String?
    ...
    private fun reconstructHistoryFromRollout(
        turnContext: TurnContext,
        rolloutItems: List<io.github.solaceharmony.codex.protocol.RolloutItem>
    ): List<ResponseItem> {
        val history = ContextManager()
        for (rolloutItem in rolloutItems) {
            when (rolloutItem) {
                is io.github.solaceharmony.codex.protocol.RolloutItem.ResponseItemHolder -> {
                    history.recordItems(listOf(rolloutItem.payload), turnContext.truncationPolicy)
                }
                is io.github.solaceharmony.codex.protocol.RolloutItem.Compacted -> {
     ...
     */
    suspend fun persistRolloutItems(items: List<io.github.solaceharmony.codex.protocol.RolloutItem>) {
     ...
     */
    suspend fun listResources(server: String, params: io.github.solaceharmony.codex.protocol.ListResourcesRequestParams?): io.github.solaceharmony.codex.protocol.ListResourcesResult {
     ...
     */
    suspend fun listResourceTemplates(server: String, params: io.github.solaceharmony.codex.protocol.ListResourceTemplatesRequestParams?): io.github.solaceharmony.codex.protocol.ListResourceTemplatesResult {
     ...
     */
    suspend fun readResource(server: String, params: io.github.solaceharmony.codex.protocol.ReadResourceRequestParams): io.github.solaceharmony.codex.protocol.ReadResourceResult {
    ...
    ): Result<io.github.solaceharmony.codex.protocol.CallToolResult> {
    ...
    object Factory {
        ...
        suspend fun new(
            ...
            val mcpServerConfigs = config.mcpServers.mapValues { (_, v) ->
                io.github.solaceharmony.codex.mcp.connection.McpServerConfig(
                    command = v.command,
                    args = v.args,
                    env = v.env
                )
    ...
    private fun makeTurnContext(
        ...
        client: io.github.solaceharmony.codex.core.client.ModelClient? = null
    ): TurnContext {
        ...
        val toolsConfig = newToolsConfig(
            io.github.solaceharmony.codex.core.tools.ToolsConfigParams(
...
data class TurnContext(
     ...
     */
    val client: io.github.solaceharmony.codex.core.client.ModelClient? = null,
    /**
    ...
    val toolsConfig: io.github.solaceharmony.codex.core.tools.ToolsConfig = io.github.solaceharmony.codex.core.tools.ToolsConfig(
        shellType = io.github.solaceharmony.codex.core.tools.ConfigShellToolType.Default,
...
// ToolsConfig is defined in io.github.solaceharmony.codex.core.tools (see core/tools/Spec.kt).
// ApplyPatchToolType is imported from io.github.solaceharmony.codex.core.tools.ToolSpec
...
private suspend fun runTurn(
    ...
    val router = io.github.solaceharmony.codex.core.tools.ToolRouter.fromConfig(turnContext.toolsConfig, mcpTools)
...
// ResponseEvent is now imported from io.github.solaceharmony.codex.protocol.models
...
// InitialHistory and SessionSource are imported from io.github.solaceharmony.codex.protocol
...
// ModelProviderInfo imported from io.github.solaceharmony.codex.core.model
// ModelFamily imported from io.github.solaceharmony.codex.core.model
// ReasoningEffort and ReasoningSummary are imported from io.github.solaceharmony.codex.protocol.ConfigTypes

// McpServerConfig is now imported from io.github.solaceharmony.codex.mcp.connection
...
class RolloutRecorder(
    ...
    companion object {
        ...
        suspend fun getRolloutHistory(path: String): CodexResult<InitialHistory> {
            ...
            var conversationId: io.github.solaceharmony.codex.protocol.ConversationId? = null
            ...
            for (line in text.lineSequence()) {
                ...
                val rolloutLine = try {
                    json.decodeFromString(
                        io.github.solaceharmony.codex.protocol.RolloutLine.serializer(),
                        line,
                    )
            ...
            return CodexResult.success(
                InitialHistory.Resumed(
                    io.github.solaceharmony.codex.protocol.ResumedHistory(
...
// CancellationToken is now imported from io.github.solaceharmony.codex.utils.concurrent

// ReadinessFlag and ReadinessToken are now imported from io.github.solaceharmony.codex.utils.readiness
...
private suspend fun runCompactTaskInner(sess: Session, turnContext: TurnContext, input: List<UserInput>) {
    ...
    val rolloutItem = RolloutItem.Compacted(
        io.github.solaceharmony.codex.protocol.CompactedItem(
            message = summaryText,
    ...
    override suspend fun run(
        ...
        execDuration = measureTime {
            val result = processExecutor.execute(
                params = execParams,
                sandboxPolicy = io.github.solaceharmony.codex.protocol.SandboxPolicy.DangerFullAccess,
                sandboxCwd = cwd
            )
...
class UndoTask : SessionTask {
    ...
    override suspend fun run(
        ...
        var foundCommit: io.github.solaceharmony.codex.utils.git.GhostCommit? = null
...
class CompactTask : SessionTask {
    ...
    override suspend fun run(
        ...
        val rolloutItem = io.github.solaceharmony.codex.protocol.RolloutItem.Compacted(
            payload = io.github.solaceharmony.codex.protocol.CompactedItem(
                message = summary,
            ...
            when (item) {
                ...
                is ResponseItem.Reasoning -> {
                    item.summary.firstOrNull()?.let { summary ->
                        if (summary is io.github.solaceharmony.codex.protocol.ReasoningItemReasoningSummary.SummaryText) {
