 ...
 */
internal fun subagentHeader(source: io.github.kotlinmania.codex.protocol.SessionSource?): String? {
    return when (source) {
        io.github.kotlinmania.codex.protocol.SessionSource.SubAgent -> "review" // TODO: get actual SubAgentSource value
        else -> null
    }
}
