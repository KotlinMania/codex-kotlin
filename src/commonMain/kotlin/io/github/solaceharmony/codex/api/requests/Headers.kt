 ...
 */
internal fun subagentHeader(source: io.github.solaceharmony.codex.protocol.SessionSource?): String? {
    return when (source) {
        io.github.solaceharmony.codex.protocol.SessionSource.SubAgent -> "review" // TODO: get actual SubAgentSource value
        else -> null
    }
}
