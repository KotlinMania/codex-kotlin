...
import io.github.solaceharmony.codex.core.auth.AuthStorageBackend
import io.github.solaceharmony.codex.core.auth.FileAuthStorage
import io.github.solaceharmony.codex.core.auth.createAuthStorage
 ...
 * Distinct from [io.github.solaceharmony.codex.core.tryParseErrorMessage] in util.rs which expects
 * `{"error": {"message": "..."}}`.
 */
