...
- Good (0.60-0.84): 84 files (72.4% of matched)
- Critical (<0.60): 14 files (12.1% of matched)
...
- `core.custom_prompts` → `prompt.Constants` (0.47)
...
4. **otel.otel_event_manager** (4 deps)
5. **execpolicy-legacy.valid_exec** (4 deps)
6. **models.paginated_list_task_list_item_** (4 deps)
7. **bottom_pane.scroll_state** (4 deps)
8. **exec.event_processor** (3 deps)
9. **core.exec_env** (3 deps)
10. **core.parse_command** (3 deps)
11. **tui.app** (3 deps)
12. **tui.slash_command** (3 deps)
13. **mcp-server.outgoing_message** (3 deps)
14. **models.task_list_item** (3 deps)
15. **models.rate_limit_window_snapshot** (3 deps)
16. **public_widgets.composer_input** (3 deps)
17. **models.rate_limit_status_payload** (3 deps)
18. **models.credit_status_details** (3 deps)
19. **models.code_task_details_response** (3 deps)
20. **execpolicy-legacy.opt** (3 deps)

## Documentation Gaps

**Documentation coverage:** 2690 / 3514 lines (77%)
