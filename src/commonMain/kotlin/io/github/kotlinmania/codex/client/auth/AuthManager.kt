...
// NOTE: Kotlin package io.github.kotlinmania.codex.client.auth maps conceptually to Rust crates codex-api (auth provider/helpers)
// and codex-core (AuthManager, storage). The Kotlin file consolidates pieces from both for KMP usage.
package io.github.kotlinmania.codex.client.auth
...
class AuthManager(
     ...
     *
     * The on-disk auth.json refresh path lives in [io.github.kotlinmania.codex.core.AuthManager].
     ...
     *
     * On-disk auth.json loading is owned by the core [io.github.kotlinmania.codex.core.AuthManager],
