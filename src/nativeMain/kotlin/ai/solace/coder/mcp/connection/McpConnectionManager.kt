...
class McpConnectionManager {
    ...
    suspend fun listResources(
            server: String,
            params: ai.solace.coder.protocol.ListResourcesRequestParams?
    ): ai.solace.coder.protocol.ListResourcesResult {
        return ai.solace.coder.protocol.ListResourcesResult(emptyList())
    }

    /** List resource templates from a specific server. */
    suspend fun listResourceTemplates(
            server: String,
            params: ai.solace.coder.protocol.ListResourceTemplatesRequestParams?
    ): ai.solace.coder.protocol.ListResourceTemplatesResult {
        return ai.solace.coder.protocol.ListResourceTemplatesResult(emptyList())
    }

    /** Read a resource from a specific server. */
    suspend fun readResource(
            server: String,
            params: ai.solace.coder.protocol.ReadResourceRequestParams
    ): ai.solace.coder.protocol.ReadResourceResult {
        return ai.solace.coder.protocol.ReadResourceResult(emptyList())
    }
