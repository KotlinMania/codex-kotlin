...
class Sha256MessageDigest {
    ...
    fun digest(sourceBytes: ByteArray): ByteArray = generate(sourceBytes)
    ...
    private fun calculatePaddingLength(sourceLength: Int): Int = (512 - (sourceLength * 8 + 64) % 512) / 8
    ...
    private fun rotateRight(x: Int, dist: Int): Int = (x ushr dist) or (x shl (32 - dist))
    ...
    private fun ch(e: Int, f: Int, g: Int): Int = (e and f) xor ((e.inv()) and g)

    private fun maj(a: Int, b: Int, c: Int): Int = (a and b) xor (a and c) xor (b and c)
}
