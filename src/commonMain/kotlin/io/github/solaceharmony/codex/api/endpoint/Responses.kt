...
import io.github.solaceharmony.codex.api.requests.ResponsesRequest
...
data class ResponsesOptions(
    ...
    val sessionSource: io.github.solaceharmony.codex.protocol.SessionSource? = null,
)
...
class ResponsesClient<A : AuthProvider>(
    ...
    private suspend fun stream(
        ...
        return streaming.stream("responses", body, configureExtraHeaders) { client, requestConfig, idleTimeout, telemetry ->
            io.github.solaceharmony.codex.api.sse.spawnResponsesStream(client, requestConfig, idleTimeout, telemetry)
        }
    }
}
