...
import io.github.solaceharmony.codex.api.common.ResponsesApiRequest
import io.github.solaceharmony.codex.api.common.TextControls
...
class ResponsesRequestBuilder(
    ...
    private var input: List<io.github.solaceharmony.codex.protocol.ResponseItem>? = null,
) {
    ...
    private var sessionSource: io.github.solaceharmony.codex.protocol.SessionSource? = null
    private var storeOverride: Boolean? = null
    private val extraHeaders: MutableMap<String, String> = mutableMapOf()

    constructor(model: String, instructions: String, input: List<io.github.solaceharmony.codex.protocol.ResponseItem>) : this() {
        this.model = model
    ...
    fun sessionSource(source: io.github.solaceharmony.codex.protocol.SessionSource?): ResponsesRequestBuilder {
        ...
        return try {
            ...
            val bodyJson = buildJsonObject {
                ...
                put("input", JsonArray(inputVal.map { item ->
                    ...
                    buildJsonObject {
                        when (item) {
                            is io.github.solaceharmony.codex.protocol.ResponseItem.Message -> {
                                put("type", "message")
                                put("role", item.role)
    ...
    private fun attachItemIds(payloadJson: JsonElement, originalItems: List<io.github.solaceharmony.codex.protocol.ResponseItem>): JsonElement {
