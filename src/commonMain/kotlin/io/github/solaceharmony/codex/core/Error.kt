...
import io.github.solaceharmony.codex.core.KnownPlan
import io.github.solaceharmony.codex.core.PlanType
...
import io.github.solaceharmony.codex.utils.readiness.CancelErr
...
sealed class CodexErr {
    ...
    data class ResponseStreamFailed(val error: io.github.solaceharmony.codex.core.ResponseStreamFailed) :
        CodexErr() {
        override fun toString(): String = error.toString()
    }
