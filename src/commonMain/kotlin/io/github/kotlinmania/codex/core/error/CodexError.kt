...
package io.github.kotlinmania.codex.core.error
...
sealed class CodexError {
    ...
    data class ResponseStreamFailed(val error: io.github.kotlinmania.codex.core.error.ResponseStreamFailed) : CodexError() {
