...
import io.github.solaceharmony.codex.core.isLikelySandboxDenied
...
import io.github.solaceharmony.codex.utils.pty.ExecCommandSession
import io.github.solaceharmony.codex.utils.pty.SpawnedPty
...
class UnifiedExecSession(
    ...
    suspend fun checkForSandboxDenial(): Result<Unit> {
        ...
        withTimeoutOrNull(20.milliseconds) { outputNotify.notified() }
