...
enum class UriBasedFileOpener {
    ...
    @SerialName("vscode-insiders") VsCodeInsiders,
    @SerialName("windsurf") Windsurf,
...
sealed class Notifications {
    @Serializable
    data class Enabled(val enabled: Boolean) : Notifications()

    @Serializable
    data class Custom(val events: List<String>) : Notifications()
