...
package io.github.solaceharmony.codex.client.http

import io.github.solaceharmony.codex.client.auth.AuthManager
import io.github.solaceharmony.codex.client.streaming.SseParser
import io.github.solaceharmony.codex.core.CodexErr
import io.github.solaceharmony.codex.core.CodexResult
import io.github.solaceharmony.codex.core.UnexpectedResponseError
 ...
 */
class StreamingClient<A : io.github.solaceharmony.codex.client.auth.AuthProvider>(
    ...
    companion object {
         ...
         */
        fun <A : io.github.solaceharmony.codex.client.auth.AuthProvider> new(
            provider: Provider,
            auth: A
