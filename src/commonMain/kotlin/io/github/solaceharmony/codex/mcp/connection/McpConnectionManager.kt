...
package io.github.solaceharmony.codex.mcp.connection

import io.github.solaceharmony.codex.protocol.CallToolResult
...
class McpConnectionManager {
    ...
    fun listAllResources(): Map<String, List<io.github.solaceharmony.codex.protocol.McpResource>> {
        return emptyMap()
    }

    /** List all resource templates from all connected servers. */
    fun listAllResourceTemplates(): Map<String, List<io.github.solaceharmony.codex.protocol.McpResourceTemplate>> {
        return emptyMap()
    }
    ...
    suspend fun listResources(
            server: String,
            params: io.github.solaceharmony.codex.protocol.ListResourcesRequestParams?
    ): io.github.solaceharmony.codex.protocol.ListResourcesResult {
        return io.github.solaceharmony.codex.protocol.ListResourcesResult(emptyList())
    }

    /** List resource templates from a specific server. */
    suspend fun listResourceTemplates(
            server: String,
            params: io.github.solaceharmony.codex.protocol.ListResourceTemplatesRequestParams?
    ): io.github.solaceharmony.codex.protocol.ListResourceTemplatesResult {
        return io.github.solaceharmony.codex.protocol.ListResourceTemplatesResult(emptyList())
    }

    /** Read a resource from a specific server. */
    suspend fun readResource(
            server: String,
            params: io.github.solaceharmony.codex.protocol.ReadResourceRequestParams
    ): io.github.solaceharmony.codex.protocol.ReadResourceResult {
        return io.github.solaceharmony.codex.protocol.ReadResourceResult(emptyList())
    }
