...
sealed class RefreshTokenError(message: String) : Exception(message) {
    class Permanent(val reason: ai.solace.coder.core.error.RefreshTokenFailedReason, message: String) : RefreshTokenError(message)
    class Transient(message: String) : RefreshTokenError(message)

    fun failedReason(): ai.solace.coder.core.error.RefreshTokenFailedReason? {
