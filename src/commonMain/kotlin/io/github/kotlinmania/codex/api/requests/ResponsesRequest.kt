...
class ResponsesRequestBuilder(
    ...
    fun sessionSource(source: io.github.kotlinmania.codex.protocol.SessionSource?): ResponsesRequestBuilder {
    ...
    private fun attachItemIds(payloadJson: JsonElement, originalItems: List<io.github.kotlinmania.codex.protocol.ResponseItem>): JsonElement {
