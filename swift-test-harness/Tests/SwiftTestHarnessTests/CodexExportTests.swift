...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Codex.swiftmodule/`
...
//      `import Codex` above would fail at compile time.
//
//   2. The static archive `libCodex.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Codex" }` and
//      `flattenPackage = "io.github.solaceharmony.codex"` configuration in
...
@Suite("CodexExportTests")
struct CodexExportTests {
    @Test("testSwiftModuleLoads")
    func testSwiftModuleLoads() {
        #expect(Bool(true), "Codex swift module imported cleanly")
    }
}
