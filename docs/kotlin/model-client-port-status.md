...
## Overview
This document specifies the as-built state of the `io.github.kotlinmania.codex.core.client.ModelClient.kt` component, which maps to the Rust `codex-rs/core/src/client.rs` implementation.
