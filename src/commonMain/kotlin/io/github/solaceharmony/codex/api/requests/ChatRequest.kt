...
class ChatRequestBuilder(
    ...
    private val input: List<io.github.solaceharmony.codex.protocol.ResponseItem>,
    ...
    fun sessionSource(source: io.github.solaceharmony.codex.protocol.SessionSource?): ChatRequestBuilder {
            ...
            for (item in input) {
                when (item) {
                    is io.github.solaceharmony.codex.protocol.ResponseItem.Message -> {
                        val textContent = item.content.filterIsInstance<io.github.solaceharmony.codex.protocol.ContentItem.OutputText>()
