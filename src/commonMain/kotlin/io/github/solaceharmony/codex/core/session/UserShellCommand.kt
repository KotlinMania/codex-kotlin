...
private fun formatUserShellCommandBody(
    ...
    truncationPolicy: io.github.solaceharmony.codex.core.context.TruncationPolicy
): String {
...
private fun formatExecOutputStr(
    ...
    return io.github.solaceharmony.codex.core.context.truncateText(content, truncationPolicy)
}

// ExecToolCallOutput is now imported from io.github.solaceharmony.codex.exec.process
